package com.vest10.peter.madklubandroid.login
...
class LoginActivity : BaseActivity(), LoaderCallbacks<Cursor> {
    ...
    // UI references.
    // TODO replace code occurenced with the kotlinx generated stuff
    ...
    private fun attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true)
            mAuthTask = UserLoginTask(typedEmail, password)
    ...
    inner class UserLoginTask internal constructor(private val mEmail: String, private val mPassword: String) : AsyncTask<Void, Void, Boolean>() {
        ...
        override fun onPostExecute(success: Boolean?) {
            ...
            if (success!!) {
                userManager.loginWithUserName(mEmail).subscribe {
